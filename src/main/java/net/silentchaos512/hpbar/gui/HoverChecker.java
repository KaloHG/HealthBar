 ...
 * certain region of the screen for a given period of time. The region can be
 * defined manually or by supplying a GuiButton object.
 *
 * @author bspkrs
 */
public class HoverChecker
{
    ...
    /**
     * Call this method if the intended region has changed such as if the region
     * must follow a scrolling list. It is not necessary to call this method if a
     * GuiButton defines the hover region.
     */
    ...
    /**
     * Checks if the mouse is in the hover region. If the specified time period has
     * elapsed the method returns true. The hover timer is reset if the mouse is not
     * within the region.
     */
